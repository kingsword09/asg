...
let gen = (function* init () {
  ...
  function trampoline10(arg0, arg1, arg2) {
    ...
    _debugLog('[iface="wasi:http/types@0.2.4", function="[method]request-options.set-connect-timeout"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:http/types@0.2.4", function="[method]request-options.set-connect-timeout"] [Instruction::CallInterface] (sync, @ post-call)');
    ...
    _debugLog('[iface="wasi:http/types@0.2.4", function="[method]request-options.set-connect-timeout"][Instruction::Return]', {
  ...
  function trampoline33(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:io/streams@0.2.6", function="[method]output-stream.flush"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:io/streams@0.2.6", function="[method]output-stream.flush"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:io/streams@0.2.6", function="[method]output-stream.flush"][Instruction::Return]', {
  ...
  function trampoline36(arg0, arg1, arg2) {
    ...
    _debugLog('[iface="wasi:http/types@0.2.4", function="[static]fields.from-list"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:http/types@0.2.4", function="[static]fields.from-list"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var variant5 = ret;
    switch (variant5.tag) {
      case 'ok': {
    ...
    _debugLog('[iface="wasi:http/types@0.2.4", function="[static]fields.from-list"][Instruction::Return]', {
  ...
  function trampoline58(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    var handle1 = arg0;
    var rep2 = handleTable14[(handle1 << 1) + 1] & ~T_FLAG;
    var rsc0 = captureTable14.get(rep2);
    if (!rsc0) {
  ...
  function trampoline65(arg0, arg1, arg2, arg3, arg4) {
    var handle1 = arg0;
    var rep2 = handleTable14[(handle1 << 1) + 1] & ~T_FLAG;
    var rsc0 = captureTable14.get(rep2);
    if (!rsc0) {
  ...
  ({ exports: exports1 } = yield instantiateCore(yield module0, {
    ...
    'wasi:http/types@0.2.2': {
      ...
      '[constructor]request-options': trampoline9,
      '[method]fields.entries': exports0['28'],
      '[method]future-incoming-response.get': exports0['19'],
      '[method]future-incoming-response.subscribe': trampoline18,
      '[method]incoming-body.stream': exports0['30'],
      '[method]incoming-response.consume': exports0['29'],
      '[method]incoming-response.headers': trampoline20,
      '[method]incoming-response.status': trampoline19,
      '[method]outgoing-body.write': exports0['26'],
      '[method]outgoing-request.body': exports0['25'],
      '[method]outgoing-request.set-authority': exports0['23'],
      '[method]outgoing-request.set-method': exports0['21'],
      '[method]outgoing-request.set-path-with-query': exports0['24'],
      '[method]outgoing-request.set-scheme': exports0['22'],
      '[method]request-options.set-connect-timeout': trampoline10,
      '[resource-drop]fields': trampoline8,
      '[resource-drop]future-incoming-response': trampoline14,
      '[resource-drop]incoming-body': trampoline1,
      '[resource-drop]incoming-response': trampoline21,
      '[resource-drop]outgoing-body': trampoline12,
      '[resource-drop]outgoing-request': trampoline13,
      '[resource-drop]request-options': trampoline11,
      '[static]fields.from-list': exports0['20'],
      '[static]outgoing-body.finish': exports0['27'],
    },
    'wasi:io/error@0.2.2': {
      '[resource-drop]error': trampoline4,
    },
    'wasi:io/error@0.2.4': {
      '[method]error.to-debug-string': exports0['35'],
      '[resource-drop]error': trampoline4,
    },
    'wasi:io/poll@0.2.0': {
    ...
    'wasi:random/insecure-seed@0.2.4': {
      'insecure-seed': exports0['31'],
    },
    'wasi:sockets/tcp@0.2.0': {
      '[resource-drop]tcp-socket': trampoline25,
    },
    'wasi:sockets/udp@0.2.0': {
      '[resource-drop]incoming-datagram-stream': trampoline23,
      '[resource-drop]outgoing-datagram-stream': trampoline24,
      '[resource-drop]udp-socket': trampoline22,
    },
    wasi_snapshot_preview1: {
      adapter_close_badfd: exports0['14'],
      environ_get: exports0['7'],
      environ_sizes_get: exports0['8'],
      fd_close: exports0['9'],
      fd_fdstat_get: exports0['10'],
      ...
      fd_tell: exports0['6'],
      fd_write: exports0['1'],
      path_create_directory: exports0['2'],
  ...
  ({ exports: exports2 } = yield instantiateCore(yield module1, {
    ...
    'wasi:cli/terminal-stdin@0.2.6': {
      'get-terminal-stdin': exports0['57'],
    },
    'wasi:cli/terminal-stdout@0.2.6': {
      'get-terminal-stdout': exports0['58'],
    },
    'wasi:filesystem/preopens@0.2.6': {
      'get-directories': exports0['56'],
    },
    'wasi:filesystem/types@0.2.6': {
      '[method]descriptor.append-via-stream': exports0['45'],
      '[method]descriptor.create-directory-at': exports0['40'],
      '[method]descriptor.get-flags': exports0['38'],
      '[method]descriptor.get-type': exports0['46'],
      '[method]descriptor.metadata-hash': exports0['48'],
      '[method]descriptor.metadata-hash-at': exports0['49'],
      '[method]descriptor.open-at': exports0['42'],
      '[method]descriptor.read-via-stream': exports0['43'],
      '[method]descriptor.stat': exports0['47'],
      '[method]descriptor.stat-at': exports0['41'],
      '[method]descriptor.write-via-stream': exports0['44'],
      '[resource-drop]descriptor': trampoline27,
      '[resource-drop]directory-entry-stream': trampoline26,
    ...
    'wasi:io/streams@0.2.6': {
      ...
      '[method]output-stream.blocking-flush': exports0['54'],
      '[method]output-stream.blocking-write-and-flush': exports0['55'],
      '[method]output-stream.check-write': exports0['52'],
      '[method]output-stream.write': exports0['53'],
      '[resource-drop]input-stream': trampoline0,
      '[resource-drop]output-stream': trampoline2,
    },
  }));
  ...
  ({ exports: exports3 } = yield instantiateCore(yield module3, {
    '': {
      ...
      '0': exports2.fd_read,
      '1': exports2.fd_write,
      '10': exports2.fd_fdstat_get,
      '11': exports2.fd_prestat_get,
      '12': exports2.fd_prestat_dir_name,
      '13': exports2.proc_exit,
      '14': exports2.adapter_close_badfd,
      '15': trampoline31,
      '16': trampoline32,
      '17': trampoline33,
      '18': trampoline34,
      '19': trampoline35,
      '2': exports2.path_create_directory,
      '20': trampoline36,
      '21': trampoline37,
      '22': trampoline38,
      '23': trampoline39,
