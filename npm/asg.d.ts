...
import type * as WasiHttpOutgoingHandler from './interfaces/wasi-http-outgoing-handler.js'; // wasi:http/outgoing-handler@0.2.2
import type * as WasiHttpTypes from './interfaces/wasi-http-types.js'; // wasi:http/types@0.2.2
...
export interface ImportObject {
  ...
  'wasi:http/outgoing-handler@0.2.2': typeof WasiHttpOutgoingHandler,
  'wasi:http/types@0.2.2': typeof WasiHttpTypes,
