...
impl TryFrom<Theme> for theme::Theme {
    ...
    fn try_from(theme: Theme) -> Result<Self, Self::Error> {
        ...
        match theme {
            Asciinema => theme::Theme::from_str(
            ...
            GithubDark => theme::Theme::from_str(
            ...
            GithubLight => theme::Theme::from_str(
            ...
            SolarizedDark => theme::Theme::from_str(
            ...
            SolarizedLight => theme::Theme::from_str(
