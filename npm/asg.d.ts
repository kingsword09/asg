...
import type * as WasiSocketsTcp from './interfaces/wasi-sockets-tcp.js'; // wasi:sockets/tcp@0.2.6
import type * as WasiSocketsUdp from './interfaces/wasi-sockets-udp.js'; // wasi:sockets/udp@0.2.6
import type * as WasiCliRun from './interfaces/wasi-cli-run.js'; // wasi:cli/run@0.2.6
export interface ImportObject {
  ...
  'wasi:sockets/tcp@0.2.6': typeof WasiSocketsTcp,
  'wasi:sockets/udp@0.2.6': typeof WasiSocketsUdp,
}
export interface Root {
  'wasi:cli/run@0.2.6': typeof WasiCliRun,
